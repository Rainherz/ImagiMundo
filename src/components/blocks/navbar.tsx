  ...
  return (
    ...
    >
      <div className="flex items-center text-xl justify-between gap-6 px-6 py-3">
        <Link href="/" className="flex shrink-0 items-center gap-2 py-5">
          {/* <Image
            src="/logo.png"
            alt="logo"
            width={94}
      ...
      <div
        className={cn(
          "bg-background mx-4 fixed inset-x-0 top-[calc(100%+1rem)] flex flex-col rounded-2xl border p-6 transition-all duration-300 ease-in-out lg:hidden",
          isMenuOpen
