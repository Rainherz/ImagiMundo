...
export function SiteHeader({ home }: { home?: boolean }) {
  ...
  return (
    <header className="flex h-(--header-height) bg-primary/50 shrink-0 items-center gap-2  transition-[width,height] ease-linear group-has-data-[collapsible=icon]/sidebar-wrapper:h-(--header-height)">
      <div
