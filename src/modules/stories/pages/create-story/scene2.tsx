...
export default function Scene2Page({
  ...
  React.useEffect(() => {
    generateImage.mutate({
      sceneContent: data.scene.imagePrompt,
      sceneNumber: data.scene.scene_number,
      storyTitle: data.storyTitle,
      userLocality: data.userLocality,
    });
  }, []);
          ...
          <div className="container flex flex-col justify-between gap-8 md:gap-14 lg:flex-row lg:gap-20">
            ...
            <div className="relative flex items-center flex-1 flex-col justify-center space-y-5 max-lg:pt-10 lg:pl-10">
              ...
              <div className="flex flex-col gap-2.5 lg:gap-5">
                <div className="p-6">
                  <MainLayoutSubTitle>{data.storyTitle}</MainLayoutSubTitle>
                ...
                <div className="flex p-6 flex-col gap-4">
                  ...
                  <div className="flex flex-col  gap-6">
                    {data.scene.options.map((option, index) => (
                      <Button
                        key={index}
